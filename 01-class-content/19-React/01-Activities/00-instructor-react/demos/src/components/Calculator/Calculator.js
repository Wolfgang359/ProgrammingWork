...
function Calculator() {
    return (
        <div>
            <p>
                19 + 341 = <Math num1={19} operator="add" num2={341} />
            </p>
            <p>42 - 17 = <Math num1={42} operator="subtract" num2={17} /></p>
            <p>100 * 3 = <Math num1={100} operator="add" num2={3} /></p>
            <p>96 / 4 = <Math num1={96} operator="divide" num2={4} /></p>
        </div>
    );
}
